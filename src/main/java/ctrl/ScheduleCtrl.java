...
// 일정관리 관련 모든 기능을 매핑시키는 컨트롤러 클래스
	...
	public String schedule(HttpServletRequest request) throws Exception {
		...
		List<ScheduleInfo> scheduleList = 
			scheduleSvc.getScheduleList(mi.getMi_id(), schYear, schMonth);
	...
	public String scheduleInProc(HttpServletRequest request, 
		...
		ScheduleInfo si = new ScheduleInfo(
			0, loginInfo.getMi_id(), si_date, si_time, content, null);
