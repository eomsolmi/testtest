...
public class FreeReply {
	...
	/*
	public FreeReply(int fr_idx, String mi_id, String fr_content, String fr_ip, String fr_date) {
		this.fr_idx = fr_idx;		this.mi_id = mi_id;			this.fr_content = fr_content;	this.fr_ip = fr_ip;		this.fr_date = fr_date;
	}*/
